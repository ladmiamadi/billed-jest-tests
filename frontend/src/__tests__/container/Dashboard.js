...
describe("filteredBills", () => {
    test("should filter bills with accepted status", () => {
        const bills = [
...
describe("card", () => {
    test("should create a card HTML for a bill", () => {
        const bill = {
            id: 1,
...
describe("when i am on Dashboard as Admin", () => {
    ...
    describe("handleShowTickets", () => {
        ...
        test("should display bills when counter is even and rotate arrow to 0deg", () => {
